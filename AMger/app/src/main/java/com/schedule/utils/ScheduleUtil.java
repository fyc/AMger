...
public class ScheduleUtil {
    ...
    public static void stard(SRunnable sr, long delay, long period, TimeUnit unit) {
        ...
        if (service == null || service.isShutdown()) init();
        ScheduledFuture scheduledFuture = service.scheduleAtFixedRate(sr, delay, period, unit);
    ...
    public static void stop(SRunnable sr) {
        ...
        if (service == null || service.isShutdown()) return;//服务未启动
